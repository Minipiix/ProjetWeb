...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	Apparement une autre méthode d'apl de script et page css        
	...
	<link rel="stylesheet" href="css/normalize.css"> 
        ...
        <style type="text/css">
			...
			.entry-header { padding-top: 20px; background-color: black; color: #fff;  width:100%; position: fixed; top: 0; left: 0; z-index: 999999}
		</style>
    </head>
    <body class="loading">
        ...
        <![endif]-->
       	...
       	<header class="entry-header">
        	<div class="inner">	
				<h1 class="entry-title">Potetoes' Parallax</h1>
			</div>
	</header>
       	<main>
